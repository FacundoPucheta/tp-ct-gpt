...
describe('obtenerPosteo', () => {
  test('Si la función recibe un parámetro que no sea un número del 1 al 100, debe devolver un status 404 y el valor null', async () => {
  ...
  // test('Si la función recibe un número del 1 al 100, debe devolver un objeto con las propiedades especificadas', async () => {
  //   const validParam = 1;
